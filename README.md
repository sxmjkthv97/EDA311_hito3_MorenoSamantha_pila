...
Para agregar elementos, vamos a VISUAL STUDIO CODE abrimos una NUEVA terminal Invoke-WebRequest -Method POST "http://localhost:8085/api/v1/insertar?elemento=Sam" y si queremos agregar otro elemento solo copiamos el mismo y cambiamos el nombre y para ver en el navegador ponemos: http://localhost:8085/api/v1/ver
...
EN CASO DE NO TENER VS abrir en powershell y poner git clone https://github.com/sxmjkthv97/EDA311_hito3_MorenoSamantha_pila.git
Entramos a la carpeta: cd EDA311_hito3_MorenoSamantha_pila y ejecutamos: .\mvnw.cmd spring-boot:run
